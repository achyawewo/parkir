...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Feb 2026 pada 16.06
...
(1, 'Administrator', 'admin', 'Achyawew01', 'admin', 1),
(2, 'Petugas Parkir', 'petugas', 'Achyawew02', 'petugas', 1),
(3, 'Owner Parkir', 'owner', 'Achyawew03', 'owner', 1);
...
--
ALTER TABLE `tb_kendaraan`
  ADD CONSTRAINT `tb_kendaraan_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `tb_transaksi`
  ...
  ADD CONSTRAINT `tb_transaksi_ibfk_2` FOREIGN KEY (`id_tarif`) REFERENCES `tb_tarif` (`id_tarif`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_transaksi_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_transaksi_ibfk_4` FOREIGN KEY (`id_area`) REFERENCES `tb_area_parkir` (`id_area`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
